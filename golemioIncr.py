...
# --- KONFIGURACE SKRIPTU ---
MIN_DELAY = 5 # Minimální zpoždění v minutách pro zápis do JSONu
...
def run_api_query():
    ...
    try:
        ...
        for feature in features:
            ...
            sequence_str = trip_data.get('sequence_id', '')
            vehicle      = trip_data.get('vehicle_registration_number', '')
            
            print(f"================================")
            print(f"linka {linka_str} / {sequence_str}  vehicle {vehicle} ")

            # trip_data {'agency_name': {'real': 'DP PRAHA', 'scheduled': 'DP PRAHA'}, 'cis': {'line_id': None, 'trip_number': None}, 'gtfs': {'route_id': 'L188', 'route_short_name': '188', 'route_type': 3, 'trip_headsign': 'Želivského', 'trip_id': '188_146_260105', 'trip_short_name': None}, 'origin_route_name': '188', 'sequence_id': 3, 'start_timestamp': '2026-03-16T20:02:00+01:00', 'vehicle_registration_number': 6917, 'vehicle_type': {'description_cs': 'autobus', 'description_en': 'bus', 'id': 3}, 'wheelchair_accessible': True, 'air_conditioned': False, 'usb_chargers': False}
